...
public class DeviceAddedEventHandler implements HubEventHandler {
    ...
    public void handle(HubEvent event) {
        ...
        log.info("Обработка события добавления устройства: {} типа {} в хабе {}",
                deviceAddedEvent.getId(), deviceAddedEvent.getDeviceType(), deviceAddedEvent.getHubId());

        hubEventProducer.sendHubEvent(deviceAddedEvent);
    }
}